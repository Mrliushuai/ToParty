...
typedef NS_ENUM(NSInteger, DDPickerContentMode) {
    DDPickerContentModeBottom, // 1.选择器在视图的下方
    DDPickerContentModeCenter  // 2.选择器在视图的中间
};

@interface DDPickerView : UIButton
...
/** 6.视图的显示模式 */
@property (nonatomic, assign)DDPickerContentMode contentMode;
