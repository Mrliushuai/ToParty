...
responseSeializerType:(DDResponseSeializerType)type
    ...
    if (type != DDResponseSeializerTypeJSON && type != DDResponseSeializerTypeDefault) {
 ...
 */
+ (AFHTTPResponseSerializer *)responseSearalizerWithSerilizerType:(DDResponseSeializerType)serilizerType {
    
    switch (serilizerType) {
            
        case DDResponseSeializerTypeDefault: // default is JSON
            return [AFJSONResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypeJSON: // JSON
            return [AFJSONResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypeXML: // XML
            return [AFXMLParserResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypePlist: // Plist
            return [AFPropertyListResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypeCompound: // Compound
            return [AFCompoundResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypeImage: // Image
            return [AFImageResponseSerializer serializer];
            break;
            
        case DDResponseSeializerTypeData: // Data
