...
- (void)btnClick:(UIButton *)btn {
    ...
    if (self.DDCustomSegmentViewBtnClickHandle) {
        self.DDCustomSegmentViewBtnClickHandle(self, title, btn.tag - 1);
    }
}
