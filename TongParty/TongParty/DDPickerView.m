...
- (void)setupDefault
{
    ...
    _heightPicker      = 240;
    _contentMode       = DDPickerContentModeBottom;
...
- (void)layoutSubviews
{
    ...
    if (self.contentMode == DDPickerContentModeBottom) {
    }else {
...
- (void)setContentMode:(DDPickerContentMode)contentMode
{
    _contentMode = contentMode;
    if (contentMode == DDPickerContentModeCenter) {
