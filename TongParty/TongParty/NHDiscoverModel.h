...
@interface NHDiscoverModel : DDBaseModel
...
@interface NHDiscoverGodComment : DDBaseModel
...
@interface NHDiscoverCategories : DDBaseModel
...
@interface NHDiscoverCategoryElement : DDBaseModel
...
@interface NHDiscoverRotate_bannerElementBanner_url_URL : DDBaseModel
