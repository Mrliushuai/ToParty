...
- (void)setup {
    ...
    [cancel setBackgroundImage:[DDUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [cancel setBackgroundImage:[DDUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
    ...
    [sure setBackgroundImage:[DDUtils imageWithColor:[[UIColor whiteColor] colorWithAlphaComponent:0.3]] forState:UIControlStateNormal];
    [sure setBackgroundImage:[DDUtils imageWithColor:[[UIColor lightTextColor] colorWithAlphaComponent:0.3]] forState:UIControlStateHighlighted];
...
- (void)showInView:(UIView *)view {
    ...
    BOOL isShowing = [DDCustomAlertView alertIsShowingInView:view];
    if (isShowing) return ;
    ...
    [DDAnimationManager addTransformAnimationForView:self.contentView];
