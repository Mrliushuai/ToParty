...
@interface DDBannerView()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@property (nonatomic, weak) UICollectionView *collectionView;
@property (nonatomic, weak) NSTimer *timer;
@property (nonatomic, weak) DDBannerPageControl *pageControl;
@end

@implementation DDBannerView
{
    UIView *_lineView;
}
- (DDBannerPageControl *)pageControl {
    if (_pageControl == nil) {
        DDBannerPageControl *pageControl = [DDBannerPageControl pageControl];
...
- (void)setModelArray:(NSArray *)modelArray {
    ...
    // 注册cell
    [self.collectionView registerClass:[DDBannerViewCell class] forCellWithReuseIdentifier:kCellIdentifier];
